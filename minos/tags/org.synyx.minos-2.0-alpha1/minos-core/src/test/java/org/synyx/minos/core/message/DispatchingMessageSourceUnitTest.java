...
import org.synyx.minos.core.message.DispatchingMessageSource;
import org.synyx.minos.core.message.MessageSourcePlugin;
import org.synyx.minos.core.message.PrefixAwareMessageSource;
...
public class DispatchingMessageSourceUnitTest {
    ...
    public void setUp() {
        ...
        PluginRegistry<MessageSourcePlugin, String> registry =
