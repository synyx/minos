...
public class DispatchingMessageSource extends AbstractMessageSource {
    ...
    private PluginRegistry<MessageSourcePlugin, String> sources =
            OrderAwarePluginRegistry.create();


    /**
     * Inject a {@link PluginRegistry} to hold all the target
     * {@link MessageSource}.
     * 
     * @param sources
     */
    public void setSources(PluginRegistry<MessageSourcePlugin, String> sources) {
    ...
    protected MessageFormat resolveCode(String code, Locale locale) {
        ...
        List<MessageSourcePlugin> candidates =
