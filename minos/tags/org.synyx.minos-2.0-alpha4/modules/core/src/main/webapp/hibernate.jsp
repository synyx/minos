...
<%@page import="org.hibernate.ejb.HibernateEntityManagerFactory"%>
...
<%
	...
	final SessionFactory sessionFactory = ((HibernateEntityManagerFactory) appContext.getBean("entityManagerFactory")).getSessionFactory();
