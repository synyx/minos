...
public class AppointmentDaoIntegrationTest extends AbstractDaoIntegrationTest {
    ...
    public void assertFindAppointmentsInAGivenTime() throws Exception {
        ...
        Appointment leakInto =
                new Appointment(new DateTime().minusMonths(1), new DateTime(),
                        "Leaks into this month!");

        // Construct an appointment overlapping the end of this month
        Appointment leakOut =
                new Appointment(new DateTime(), new DateTime().plusMonths(1),
        ...
        Appointment containing =
                new Appointment(monthStart.minusDays(1), monthEnd.plusDays(1),
                        "Containing appointment");

        Appointment contained =
                new Appointment(monthStart.plusDays(1), monthEnd.minusDays(1),
                        "Cointained appointment");

        // Construct an appointment starting right at the start of the next
        // month
        Appointment startAtEnd =
                new Appointment(monthEnd, monthEnd.plusDays(1),
                        "Starting first of next month!");

        Appointment endAtStart =
                new Appointment(monthStart.minusDays(1), monthStart,
                        "Ending at start of the month!");
