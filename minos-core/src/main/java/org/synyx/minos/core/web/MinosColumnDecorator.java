...
/**
 * Basic column decorator that automatically decorates instances of very basic
 * types to String values. Currently the following types are decorated
 * automatically:
 * <ul>
...
public class MinosColumnDecorator implements DisplaytagColumnDecorator {
     ...
     * 
     * @see
     * org.displaytag.decorator.DisplaytagColumnDecorator#decorate(java.lang
     * .Object, javax.servlet.jsp.PageContext,
     ...
     * 
     * @param instant the {@link ReadableInstant} to get the
     *            {@link DateTimeFormatter} for
     * @param locale the Locale to get the {@link DateTimeFormatter} for
     * @return {@link DateTimeFormatter}
     */
    private DateTimeFormatter getFormatterForInstant(ReadableInstant instant,
            Locale locale) {
