 ...
 * <p>
 * Implementations will typically be based on {@link SimpleNoOpLifecycle} to
 * allow selective overriding of lifecycle methods.
 * <p>
 * Furthermore implementations should consider to define an order the wish to be
 * executed in. This way, they can rely on other {@link Lifecycle}s being
 * invoked before or after in the appropriate phase.
 * 
...
public interface Lifecycle {
    ...
    /**
     * Installation phase of a module's lifecycle. This phase will only be
     * invoked once if it finishes successfully.
     * 
     * @throws ModuleLifecycleException if the module could not be installed
     *             properly.
     */
