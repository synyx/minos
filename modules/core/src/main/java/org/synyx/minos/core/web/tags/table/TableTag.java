...
/**
 * Custom table tag implementation tweaking tag defaults a little. Sorting is
 * handled externally by default. A {@link SpringDecoratorFactory} is
 * registered, that allows to lookup decorators via Spring bean names using the
 * {@code decorator} attribute on {@code table} and {@code column} tags.
 * Furthermore we configure we configure displaytag library to use Spring I18N
 * adapters.
 * 
