...
/**
 * Base implementation of {@link NotificationProvider} leveraging a {@link TaskExecutor} for noification execution.
...
public abstract class AbstractNotificationProvider extends AbstractMetadataBasedPlugin implements NotificationProvider {
    ...
    private static final TaskExecutor DEFAULT_TASK_EXECUTOR = new SyncTaskExecutor();
    ...
    public void setTaskExecuter(TaskExecutor taskExecuter) {
        ...
        this.taskExecutor = (null == taskExecuter) ? DEFAULT_TASK_EXECUTOR : taskExecuter;
    }
     ...
     * @param recipient
     */
    public abstract void notifyInExecutor(Notification notification, User recipient);
}
