...
public class AppointmentUnitTest {
    ...
    public void setUp() {
        ...
        period = new TimePeriod(fivePm, sixPm);

        // Appointment from 17:00 to 18:00
        reference = new Appointment(period);
    }
    ...
    public void testPreventsEndBeforeStart() {
        ...
        new Appointment(new TimePeriod(sixPm, fivePm));
    }
    ...
    public void testDetectsOverlaps() {
        ...
        Appointment appointment =
                new Appointment(new TimePeriod(fourPm, quaterPastFivePm));
        assertOverlap(appointment, reference);

        // Appointment from 17:15 to 17:45
        appointment =
                new Appointment(new TimePeriod(quaterPastFivePm, quaterToSix));
        assertOverlap(appointment, reference);

        appointment = new Appointment(new TimePeriod(fourPm, fivePm));
    ...
    public void allDayFlagSetsTimeBordersCorrectly() {
        ...
        Appointment appointment = new Appointment(period);
