...
public class CalendarServiceImpl implements CalendarService {
    ...
    public AppointmentList getAppointments() {
        ...
        return new AppointmentList(appointmentDao.readAll());
    }
    ...
    public AppointmentList getAppointments(User user) {
        ...
        return new AppointmentList(appointmentDao.findByUser(user));
    }
    ...
    public AppointmentList getAppointments(TimePeriod period) {
        ...
        return new AppointmentList(appointmentDao.findByStartAndEnd(period
