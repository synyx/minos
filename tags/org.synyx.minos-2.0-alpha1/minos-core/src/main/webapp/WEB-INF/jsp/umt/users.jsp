...
<display:table id="user" name="users" requestURI="users" >
	...
	<minos:column class="actions" titleKey="core.ui.actions" sortable="false">
		...
		<core:imageLink href="users/${user.id}" imageUrl="/images/umt/user_edit.png" altKey="core.ui.edit"></core:imageLink>
	...
	<display:footer>
		<tr>
			<td colspan="8">
				<core:imageLink href="users/form" imageUrl="/images/umt/user_add.png" altKey="umt.users.new" />
			</td>
		</tr>
	</display:footer>
</display:table>
